	...
	<view class="content">
		...
		<view class="list">
			...
			<view class="item" v-for="(item, index) in appliction" :key="index">
				{{item.name}}
				<switch @change="(e) => onChange(e.detail.value,'appliction', index)" class="switch" name="switch"
					:checked="item.isAlive" />
			</view>
		</view>
		...
		<view class="list">
			<view class="item" v-for="(item, index) in terminal" :key="index">
				{{item.name}}
				<switch @change="(e) => onChange(e.detail.value, 'terminal', 'name')" class="switch" name="switch"
					:checked="item.isAlive" />
			</view>
